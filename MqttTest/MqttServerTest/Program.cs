    ...
    class Program
    {
        ...
        private static void MqttServer_ApplicationMessageReceived(object sender, MqttApplicationMessageReceivedEventArgs e)
        {
            try
            {
                ...
                if (e.ApplicationMessage.Topic == "config")
                {
                    var appMsg = new MqttApplicationMessage(e.ApplicationMessage.Topic, Encoding.UTF8.GetBytes("收到了"), MqttQualityOfServiceLevel.AtMostOnce, false);
